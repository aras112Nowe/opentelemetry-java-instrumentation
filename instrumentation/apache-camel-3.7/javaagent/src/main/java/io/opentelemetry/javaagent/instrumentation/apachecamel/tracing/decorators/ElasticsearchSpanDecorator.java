...
public class ElasticsearchSpanDecorator extends AbstractSpanDecorator {
    ...
    public String getOperationName(Exchange exchange, Endpoint endpoint) {
        Map<String, String> queryParameters = AbstractSpanDecorator.toQueryParameters(endpoint.getEndpointUri());
    ...
    public void pre(SpanAdapter span, Exchange exchange, Endpoint endpoint) {
        ...
        String cluster = AbstractSpanDecorator.stripSchemeAndOptions(endpoint);
        if (cluster != null) {
